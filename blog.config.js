...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，I LOVE READING 📖, Hi，I LOVE RUNNING 🏃,Hi，I LOVE PLAYING BASKETBALL 🏀,WELCOME TO MY WORLD 👏',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Lueffy', // 您的昵称
  BIO: process.env.NEXT_PUBLIC_BIO || '一个热情的傻瓜', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.dftba.fun', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'dftba, lueffy, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'dftba.effy@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/lueffy', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  // 作废配置
  AVATAR: process.env.NEXT_PUBLIC_AVATAR || '/avatar.ico', // 作者头像，被notion中的ICON覆盖。若无ICON则取public目录下的avatar.png
